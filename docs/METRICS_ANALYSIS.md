...
- 2026-06-25T21:14:08Z +30일 acquisition snapshot에서는 `newUsers` 684 / 직전 222 = `+208.1%`, `activeUsers` 933 / 직전 468 = `+99.4%`, `sessions` 7,392 / 직전 4,428 = `+66.9%`로 반등했다. `Organic Search` 신규는 374명(`54.7%`)으로 #65 기준선 178명을 크게 넘었지만 `Direct` 신규도 310 / 684 = `45.3%`로 남아 있다. 따라서 #65/#242 판단은 신규 유저 반등보다 Play Console Search/Explore, external/campaign, Paid Search 집행 여부 확인을 우선한다.
