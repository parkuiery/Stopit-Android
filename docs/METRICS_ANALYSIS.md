...
- 2026-06-26T02:07:51Z +30일 acquisition snapshot에서는 `newUsers` 688 / 직전 222 = `+209.9%`, `activeUsers` 938 / 직전 468 = `+100.4%`, `sessions` 7,486 / 직전 4,428 = `+69.1%`로 반등했다. `Organic Search` 신규는 378명(`54.9%`)으로 #65 기준선 178명을 크게 넘었지만 `Direct` 신규도 310 / 688 = `45.1%`로 남아 있다. 따라서 #65/#242 판단은 신규 유저 반등보다 Play Console Search/Explore, external/campaign, Paid Search 집행 여부 확인을 우선한다.
