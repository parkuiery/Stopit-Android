...
- `docs/LOCK_HISTORY_PERFORMANCE_REPORT_MVP.md`: #465용 LockHistory 성과 리포트 UX 계약. 개인 성과 해석/재방문 동기를 #211 공유 루프와 분리하고, empty/low-data 카피, top apps positive framing, PR #566/#579 TalkBack contentDescription baseline, privacy-safe `lock_history_*` analytics bucket, 14일/30일 readback 경계를 정리한다.
