...
- [ ] Android Release QA passes on the PR:
  ...
  - `Release instrumentation QA` runs, in order, on a GitHub-hosted Android emulator:
    ...
    7. `:app:connectedDevDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.notClass=com.uiery.keep.feature.routine.RoutineExactAlarmPermissionIntegrationTest,com.uiery.keep.receiver.ReceiverExactAlarmPermissionIntegrationTest`
...
- [ ] Android Release QA exact alarm evidence is explicit in the PR body:
  ...
  - `:app:connectedDevDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.notClass=com.uiery.keep.feature.routine.RoutineExactAlarmPermissionIntegrationTest,com.uiery.keep.receiver.ReceiverExactAlarmPermissionIntegrationTest`
