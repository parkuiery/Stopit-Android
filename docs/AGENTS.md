...
| `SHARED_UI_OWNERSHIP_BOUNDARY.md` | #492용 공유 UI 소유권 / feature-private component import 경계. #492 closed 이후 PermissionSettingDialog/TimerPicker app shared UI baseline과 future drift static guard 기준. |
