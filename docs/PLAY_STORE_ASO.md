...
| 전체 `sessions` | 4,651 | 직전 6,372 대비 -27.0% | 유입 반등이 참여 회복으로 충분히 이어졌다고 보기 어려움 |
...
| 2026-06-02 중간 스냅샷 | 402 | 172 | 230 | 0 | 658 | 4,651 | `TODO` | `TODO` | `TODO` | 전체 신규/활성은 반등했지만 Organic Search는 기준선 178보다 낮고 Direct가 57.2%까지 커져 ASO 효과 판정 보류 |
