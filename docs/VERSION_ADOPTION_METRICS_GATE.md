...
| --- | --- | --- | ---: | --- | --- |
| #13 | #296/#318/#358 (`47e43784`, `8d2ee10`, `6ceaecc4`) | `origin/develop` 포함, `origin/main`/`v1.7.7` 미포함, Play 배포 미확인 | `267 / 821 = 32.5%` | 충분 | GA4 Admin + PR 포함 release/tag/Play deploy 후 D+14 screen quality 재조회 |
