...
운영 예시: 2026-06-08T02:10:51Z 스냅샷에서 최신 관측 버전 `1.7.7` activeUsers는 205명, 전체 activeUsers는 795명이므로 `205 / 795 = 25.8%`다. 이 상태는 `주의`이지만 30% 미만이므로, `newUsers +58.0%`나 screen/ad/review smoke를 최신 수정 성과로 승격하지 않는다.
