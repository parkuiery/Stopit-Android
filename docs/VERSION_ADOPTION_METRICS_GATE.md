...
운영 예시: 2026-06-06T02:10:31Z 스냅샷에서 최신 관측 버전 `1.7.7` activeUsers는 145명, 전체 activeUsers는 767명이므로 `145 / 767 = 18.9%`다. 이 상태는 `주의`이지만 30% 미만이므로, `newUsers +39.8%`나 screen/ad/review smoke를 최신 수정 성과로 승격하지 않는다.
