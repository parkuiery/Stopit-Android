...
운영 예시: 2026-06-03 스냅샷에서 최신 관측 버전 `1.7.7` activeUsers는 31명, 전체 activeUsers는 688명이므로 `31 / 688 = 4.5%`다. 이 상태는 `보류`이며, `newUsers +18.0%`나 screen/ad/review smoke를 최신 수정 성과로 승격하지 않는다.
