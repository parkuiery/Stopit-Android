...
| `surface` | 루틴 생성 CTA/반복 차단 추천 노출 표면 (`home`, `lock_history`, `performance_report`, `post_block_success`). #531에서 `performance_report`는 구현 표면, `post_block_success`는 code constant / 미구현 UI 표면이다. |
