...
- 2026-06-01/2026-06-03 스냅샷처럼 `Direct` 신규 비중이 커지거나 `Paid Search` 활성/세션만 남는 경우, ASO 효과 판정 전에 #242 attribution gate를 적용한다. 2026-06-03T19:07:42Z live readback 기준 전체 `newUsers`는 461명으로 직전 대비 +28.1%였지만 `Direct` 신규가 284명(61.6%)으로 유지됐고 `Organic Search` 신규는 177명으로 #65 기준선 178명보다 낮다. `sessions`도 4,804회로 직전 6,350회 대비 -24.3%다. 즉 Play Console Search/Explore와 GA4 `Organic Search`가 같은 방향인지, external/campaign/UTM 누락이 아닌지 확인한 뒤 #65의 14일/30일 결론을 쓴다.
