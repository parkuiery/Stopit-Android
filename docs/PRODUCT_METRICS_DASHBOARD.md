...
- 2026-06-01/2026-06-07 스냅샷처럼 `Direct` 신규 비중이 커지거나 `Paid Search` 활성/세션만 남는 경우, ASO 효과 판정 전에 #242 attribution gate를 적용한다. 2026-06-26T02:07:51Z(+30일) live readback 기준 전체 `newUsers`는 688명으로 직전 대비 +209.9%였고 `Organic Search` 신규는 378명으로 #65 기준선 178명을 크게 넘었지만 `Direct` 신규도 310명(45.1%)으로 남아 있다. `sessions`도 7,486회로 직전 4,428회 대비 +69.1%다. 즉 Play Console Search/Explore와 GA4 `Organic Search`가 같은 방향인지, external/campaign/UTM 누락이 아닌지 확인한 뒤 #65의 14일/30일 결론을 쓴다.
