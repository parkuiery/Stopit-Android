...
- 2026-06-01/2026-06-03 스냅샷처럼 `Direct` 신규 비중이 커지거나 `Paid Search` 활성/세션만 남는 경우, ASO 효과 판정 전에 #242 attribution gate를 적용한다. 2026-06-03T15:18:34Z live readback 기준 전체 `newUsers`는 457명으로 직전 대비 +26.9%였지만 `Direct` 신규가 281명(61.5%)으로 더 커졌고 `Organic Search` 신규는 176명으로 #65 기준선 178명보다 낮다. `sessions`도 4,744회로 직전 6,350회 대비 -25.3%다. 즉 Play Console Search/Explore와 GA4 `Organic Search`가 같은 방향인지, external/campaign/UTM 누락이 아닌지 확인한 뒤 #65의 14일/30일 결론을 쓴다.
