...
| 항목 | baseline (2026-05-27 기준) | +14일 | 해석 |
| --- | --- | --- | --- |
| `screen_view` 총량 | `11,567` | `TODO` | |
| `(not set)` `unifiedScreenName` | `8,780` | `TODO` | |
| 빈 `unifiedScreenName` | `807` | `TODO` | |
| `(not set)+빈 값` 비율 | `82.9%` | `TODO` | |
