...
- 2026-06-03 live readback(`2026-06-03T15:18:34Z`)에서도 전체 `newUsers`가 457명으로 직전 30일 대비 +26.9%였지만 `Direct` 신규가 281명(61.5%)으로 더 커졌고 `Organic Search` 신규는 176명으로 #65 기준선 178명보다 낮으며 `sessions`는 4,744회로 직전 6,350회 대비 -25.3%다. 따라서 현재 신규 유입 반등은 #242 외부 확인 전까지 ASO 회복이 아니라 attribution 판정 보류 신호로 본다.
