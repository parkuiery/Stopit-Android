...
- 2026-06-02 스냅샷에서는 전체 `newUsers`가 402명으로 직전 30일 대비 +11.0%였지만 `Direct` 신규가 230명(57.2%)까지 올라갔고 `Organic Search` 신규는 172명으로 #65 기준선 178명보다 낮다. 따라서 현재 신규 유입 반등은 #242 외부 확인 전까지 ASO 회복이 아니라 attribution 판정 보류 신호로 본다.
