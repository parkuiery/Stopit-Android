...
- 2026-06-03 screen quality smoke(`13,780 / 22,584 = 61.0%`)처럼 live 수치가 개선처럼 보여도, 관련 screen-view 보강 PR이 `origin/main`/production tag에 없으면 post-fix 성과로 승격하지 않고 release boundary 전 중간 smoke로만 기록한다.
