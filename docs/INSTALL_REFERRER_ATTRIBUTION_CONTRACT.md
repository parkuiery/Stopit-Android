...
- 2026-06-09T15:25:30Z live readback 기준 `newUsers = 571`이지만 `Direct = 336 / 571 = 58.8%`로 과다하다.
...
- `Paid Search`는 신규 0명인데 활성 19명·세션 149회가 남아 있어 신규 획득 성과가 아니라 과거 사용자/재방문/분류 잔상 가능성이 크다.
