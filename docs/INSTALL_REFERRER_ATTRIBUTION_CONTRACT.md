...
- 2026-06-08T02:10:51Z live readback 기준 `newUsers = 564`이지만 `Direct = 334 / 564 = 59.2%`로 과다하다.
- `Organic Search = 230 / 564 = 40.8%`로 #65 기준선 178명을 넘었지만, Play Console Search/Explore와 external/campaign source가 확인되지 않아 ASO 회복으로 표현하지 않는다.
