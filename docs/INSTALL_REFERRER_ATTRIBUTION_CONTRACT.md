...
- 2026-06-30T17:09:40Z(post-+30일) live readback 기준 `newUsers = 661`이고 `Organic Search = 409 / 661 = 61.9%`로 #65 기준선 178명을 크게 넘었다.
- 다만 `Direct = 252 / 661 = 38.1%`로 2026-06-26의 45.1%보다는 더 완화됐지만, Play Console Search/Explore와 external/campaign source가 확인되지 않아 ASO 회복으로 표현하지 않는다.
- `Paid Search`는 신규 0명인데 활성 20명·세션 227회가 남아 있어 신규 획득 성과가 아니라 과거 사용자/재방문/분류 잔상 가능성이 크다.
