...
- 2026-06-18T17:42:25Z live readback 기준 `newUsers = 611`이지만 `Direct = 339 / 611 = 55.5%`로 과다하다.
- `Organic Search = 272 / 611 = 44.5%`로 #65 기준선 178명을 넘었지만, Play Console Search/Explore와 external/campaign source가 확인되지 않아 ASO 회복으로 표현하지 않는다.
