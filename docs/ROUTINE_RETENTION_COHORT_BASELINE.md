...
- 최신 버전 `1.7.7` active share는 2026-06-14T00:09:03Z 기준 `317 / 841 = 37.7%`로 `docs/VERSION_ADOPTION_METRICS_GATE.md` 기준 `충분`이다. 다만 최신 develop PR의 효과로 해석하려면 main/tag/Play 포함 여부와 D+14/D+30 같은 쿼리 창 재측정을 같이 확인한다.
