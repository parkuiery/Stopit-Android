...
9. release remaining connected Android suite
   ...
   - 목적: release smoke, backup/restore runtime reset, accessibility permission resume, Room migration, routine start notification tap intent, receiver 단일·multi-day 재수화/재예약, manifest contract, emergency unlock expiry, FCM token wiring, AccessibilityService cross-app block safety를 한 묶음으로 검증
