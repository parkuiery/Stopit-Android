...
LATEST_TIMESTAMP = "2026-06-05T21:24:54Z"
LATEST_VALUES = [
    "520",
    "333",
    "187",
...
class AcquisitionAttributionDocsContractTest(unittest.TestCase):
    def test_latest_acquisition_snapshot_is_consistent_across_high_traffic_docs(self):
        ...
        self.assertIn("64.0%", product_context)
        ...
        self.assertIn("Organic Search` 신규 사용자 | 187", review_prompt_followthrough)
        self.assertIn("Direct` 신규 사용자 | 333", review_prompt_followthrough)
        self.assertIn("64.0%", review_prompt_followthrough)
    ...
    def test_screen_quality_and_version_guardrails_are_consistent_across_docs(self):
        ...
        self.assertIn("144 / 766 = 18.8%", version_gate)
    ...
    def test_play_store_aso_keeps_manual_attribution_boundary_explicit(self):
        ...
        self.assertIn("2026-06-05 live readback", play_store_aso)
        self.assertIn("Direct 64.0% 과다 상태 유지", play_store_aso)
