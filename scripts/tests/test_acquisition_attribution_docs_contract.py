...
LATEST_TIMESTAMP = "2026-06-03T15:18:34Z"
LATEST_VALUES = [
    "457",
    "281",
    "176",
...
class AcquisitionAttributionDocsContractTest(unittest.TestCase):
    def test_latest_acquisition_snapshot_is_consistent_across_high_traffic_docs(self):
        ...
        self.assertIn("61.5%", product_context)
    ...
    def test_play_store_aso_keeps_manual_attribution_boundary_explicit(self):
        ...
        self.assertIn("2026-06-03 second live readback", play_store_aso)
        self.assertIn("Direct 61.5%까지 상승", play_store_aso)
        ...
        self.assertIn("활성 19명·세션 200회는 신규 유입 성과가 아니라", play_store_aso)
