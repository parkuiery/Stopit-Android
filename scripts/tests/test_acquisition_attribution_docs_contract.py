...
LATEST_TIMESTAMP = "2026-06-04T20:14:53Z"
LATEST_VALUES = [
    "506",
    "327",
    "179",
...
class AcquisitionAttributionDocsContractTest(unittest.TestCase):
    def test_latest_acquisition_snapshot_is_consistent_across_high_traffic_docs(self):
        ...
        self.assertIn("64.6%", product_context)
        ...
        self.assertIn("Direct` 신규 사용자 | 327", review_prompt_followthrough)
        self.assertIn("64.6%", review_prompt_followthrough)
    ...
    def test_screen_quality_and_version_guardrails_are_consistent_across_docs(self):
        ...
        self.assertIn("107 / 757 = 14.1%", version_gate)
    ...
    def test_play_store_aso_keeps_manual_attribution_boundary_explicit(self):
        ...
        self.assertIn("2026-06-04 late live readback", play_store_aso)
        self.assertIn("Direct 64.6%까지 상승", play_store_aso)
        ...
        self.assertIn("활성 18명·세션 190회는 신규 유입 성과가 아니라", play_store_aso)
