...
## Purpose
Instrumented-test package namespace container.
...
| Directory | Purpose |
|-----------|---------|
| `uiel/` | Legacy package namespace container used by the sample instrumented test. (see `uiel/AGENTS.md`) |
| `uiery/` | Instrumented-test namespace container. (see `uiery/AGENTS.md`) |
