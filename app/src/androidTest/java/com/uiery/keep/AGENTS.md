...
## Purpose
Instrumented test application package root.
...
| Directory | Purpose |
|-----------|---------|
| `database/` | Instrumented Room migration tests that validate schema upgrades against exported JSON schemas. (see `database/AGENTS.md`) |
