...
## Purpose
Room type converters for Java/Kotlin time types and list serialization used by database entities.

## Key Files
| File | Description |
|------|-------------|
| `DayOfWeekTypeConverter.kt` | Room converter for DayOfWeek values. |
| `ListStringTypeConverter.kt` | Room converter for ListString values. |
| `TimeTypeConverter.kt` | Room converter for Time values. |
