...
## Purpose
Menu/settings feature for navigation and toggles outside the primary home flow.

## Key Files
| File | Description |
|------|-------------|
| `MenuNavigation.kt` | Type-safe navigation route and graph wiring for Menu. |
| `MenuScreen.kt` | Compose screen for the Menu flow. |
| `MenuViewModel.kt` | Orbit MVI view-model/state holder for Menu. |

## Subdirectories
| Directory | Purpose |
|-----------|---------|
| `component/` | Menu row and toggle composables. (see `component/AGENTS.md`) |
