...
## Purpose
Onboarding step for requesting and validating required Android permissions.

## Key Files
| File | Description |
|------|-------------|
| `PermissionSettingNavigation.kt` | Type-safe navigation route and graph wiring for PermissionSetting. |
| `PermissionSettingScreen.kt` | Compose screen for the PermissionSetting flow. |
| `PermissionSettingViewModel.kt` | Orbit MVI view-model/state holder for PermissionSetting. |

## Subdirectories
| Directory | Purpose |
|-----------|---------|
| `component/` | Permission onboarding dialog components. (see `component/AGENTS.md`) |
