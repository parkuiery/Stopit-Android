...
## Purpose
Onboarding step for notification setup and related analytics/state handling.

## Key Files
| File | Description |
|------|-------------|
| `NotificationSettingNavigation.kt` | Type-safe navigation route and graph wiring for NotificationSetting. |
| `NotificationSettingScreen.kt` | Compose screen for the NotificationSetting flow. |
| `NotificationSettingViewModel.kt` | Orbit MVI view-model/state holder for NotificationSetting. |
