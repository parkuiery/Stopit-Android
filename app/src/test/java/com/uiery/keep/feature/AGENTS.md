...
## Purpose
Feature unit-test package container.
...
| Directory | Purpose |
|-----------|---------|
| `onboarding/` | Onboarding feature unit tests, especially analytics emission from view-model actions. (see `onboarding/AGENTS.md`) |
